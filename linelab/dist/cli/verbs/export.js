...
import { errOutcome, okOutcome, isObject, parseJson, recomposeEnvelopeRoad, roadWireSpec, schemaErr } from "./shared.js";
...
export function exportVerb(input) {
    ...
    if (asTyped === "scenario") {
        ...
        if (!roadSpec.ok)
            return errOutcome(roadSpec.error);
        return okOutcome({ ...rs, spec: "linelab/1", id: line.line_id, road: roadSpec.value }, undefined, EXIT.OK);
    }
