...
function figureSection() {
    return {
        name: "figure",
        prose: "design/03 §8/D30 — the canonical FigureSpec JSON: {road, occluders?, hazards?, lines: [{name, role, spec}], labels?, marks?, view?, note?, placards?}. Scene text lowers onto this exact shape.",
        fields: [
