...
function sceneSection() {
    return {
        name: "scene",
        prose: "design/04 §7's scene-text grammar (D30 sugar over FigureSpec JSON): top-level keys road/lines/occluders/hazards/marks/labels/view/note; `lines:`/`labels:` entries indented. lowerScene is the pure, total lowering.",
        grammar: [
...
function figureSection() {
    return {
        name: "figure",
        prose: "design/03 §8/D30 — the canonical FigureSpec JSON: {road, occluders?, hazards?, lines: [{name, role, spec}], labels?, marks?, view?, note?}. Scene text lowers onto this exact shape.",
        fields: [
...
function viewSection() {
    return {
        name: "view",
        prose: "design/06 §2.1 — the v0.1-legal ViewSpec surface: mode (\"true\" only — \"diagram\" is deferred, ARCHITECTURE §6.5/§6.4), window, orient, rays, legend. look is deferred (immersion, v0.3).",
        fields: [
