 ...
 * can never disagree.
 */
export function placeGlyph(instant, line, scene) {
...
export function glyphSvg(g) {
    ...
    return (`<g data-overlay="glyph" data-line="${g.line_id}" ` +
 ...
 */
export function withOverlay(svg, overlay) {
