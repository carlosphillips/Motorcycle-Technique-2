 ...
 */
export function wrapPlacard(text, maxChars = PLACARD_WRAP_CHARS) {
...
export function placardBoxHeightPx(lines) {
 ...
 */
export function placardBandHeightPx(placards, maxChars = PLACARD_WRAP_CHARS) {
...
//# sourceMappingURL=placards.js.map