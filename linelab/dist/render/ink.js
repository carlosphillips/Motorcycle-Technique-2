...
export const ROLE_DRAW_ORDER = ["reference", "alternative", "mistake", "ideal"];
 ...
 */
export function trajectoryInk(role) {
    if (role === "ideal")
        return { width: W_IDEAL, dash: null, arrowhead: true };
    if (role === "reference")
        return { width: W_REF, dash: DOT_REF, arrowhead: true };
...
export function terminalGlyphFor(reason) {
    switch (reason) {
        case "off_road":
...
export function glyphKeepsArrowhead(glyph) {
