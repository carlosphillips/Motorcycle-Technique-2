...
import type { CornerType, Hand, Outcome, ResolvedHazard, ResolvedOccluder, ResolvedScenario, RoadModel, Trajectory } from "../core/types.js";
...
import type { AcceptPolicy, ConstraintBound, FigureRole, MistakeSpec, PlanAction, Scenario, SolveSpec } from "../plan/types.js";
import type { RoadSpec } from "../road/types.js";
import type { CorrectiveBlock } from "./corrective.js";
export type { CounterfactualRider, CfPredicate, CfRefusal, CfRefusalReason, CfRiderRecord, CfPredicateRecord, CfLaunchSample, CfLaunchState, CfShadowDocument, CfVerdict, CfOutcome } from "./counterfactual.js";
...
export type { CorrectiveBlock, CorrectiveFailReason, CorrectiveShotInput, CorrectiveShotResult, RunWideDetect } from "./corrective.js";
export { CORRECTIVE_FAIL_REASONS, CORRECTIVE_BINDING, CORRECTIVE_DISCLOSURE } from "./corrective.js";
export type { Standing, StandingRung, StandingReport, ReserveRow, ReserveBlock, ReserveBlockReason } from "./standing.js";
/** design/05 §7/§8.1 — `FigureResult.spec` / `FigureSpec.spec` pinned literal. */
export declare const LINELAB_SPEC: "linelab/1";
/** design/05 §6.3 — `Verdict.engine` pinned literal. */
export declare const ENGINE_ID: "linelab/1";
export declare const NO_SOLUTION_SUB_REASONS: readonly ["turn_in_infeasible_early", "turn_in_infeasible_late", "empty_band", "non_clean_band", "coarse_fine_disagreement", "constraint_unmet", "road_too_short", "no_double_apex_geometry", "no_two_touch_line", "believed_world_not_clean", "no_rankable_candidate", "authored_action_conflict", "link_flip_infeasible", "vis_unsatisfiable_within_bound", "vis_speed_below_model_floor"];
export type NoSolutionSubReason = (typeof NO_SOLUTION_SUB_REASONS)[number];
export declare const DIAGNOSIS_CAUSES: readonly ["overspeed_entry", "grip_exceeded", "roll_rate_limited", "sight_deficit", "late_brake", "plan_gap", "stand_up"];
...
export declare const MISJUDGE_DIVERGENCE_KINDS: readonly ["radius", "sweep", "structure"];
...
export declare const CACHE_STATES: readonly ["hit", "stale_engine", "stale_spec", "absent"];
export type CacheState = (typeof CACHE_STATES)[number];
/** Per-line tiers, ordered `match < unstamped < detail < story`. */
export declare const LINE_SKEW_TIERS: readonly ["match", "unstamped", "detail", "story"];
...
export declare const FIGURE_SKEW_TIERS: readonly ["match", "info", "detail", "story"];
...
export type LineSource = {
    ...
    readonly kind: "solve";
    readonly solveSpec: SolveSpec;
} | {
    readonly kind: "mistake";
    readonly base_line_id: string;
    readonly mistakeSpec: MistakeSpec;
} | {
...
export declare const GATE_EXPECT_SOURCES: readonly ["explicit_expect", "mistake_pin", "best_failing", "chained_vis", "default"];
