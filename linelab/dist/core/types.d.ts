...
export declare const SSD_MODELS: readonly ["alert", "aashto"];
export type SsdModel = (typeof SSD_MODELS)[number];
/** design/02 §3 rider profile names (values live in core/constants.ts, all TUNING). */
export declare const RIDER_PROFILE_NAMES: readonly ["casual", "street", "trained", "racer"];
...
export declare const STEER_STATES: readonly ["track", "commit", "unwind", "position"];
 ...
 */
export declare const TERMINATED_REASONS: readonly ["crash", "off_road", "stopped", "road_end", "max_time", "max_dist"];
 ...
 */
export declare const OUTCOMES: readonly ["crash", "runoff", "wide", "stopped", "contained"];
export type Outcome = (typeof OUTCOMES)[number];
/** design/05 §4.1 — closed five-token phase set, disjoint from anchors and event kinds. */
export declare const PHASES: readonly ["approach", "turning", "midcorner", "exiting", "done"];
 ...
 */
export declare const EVENT_KINDS: readonly ["brake_start", "brake_end", "turn_in", "steering_complete", "crack", "roll_on", "apex", "exit", "release", "position_start", "position_complete", "position_shortfall", "sight_min", "run_wide_detect", "correction", "off_road", "hazard_visible", "violation", "crash", "stop", "road_end"];
 ...
 */
export declare const SAMPLE_FIELDS: readonly ["s", "t", "x", "y", "psi", "v", "phi", "kappa", "a_long", "a_lat", "grip", "mu", "d", "f", "cmd_lean", "cmd_a", "roll_rate", "action_id", "clipped", "n_long", "n_lat", "sight_m", "ssd_m", "limit_x", "limit_y", "sight_ride_m", "steer_state", "lat_action_id", "su_sustained", "su_transient", "a_cmd_rate", "below_validity"];
...
export interface RoadModel {
    ...
    readonly project: (x: number, y: number) => {
        readonly s: number;
        readonly d: number;
    };
}
 ...
 */
export type ResolvedPlanAction = ResolvedBrakeAction | ResolvedTurnInAction | ResolvedThrottleAction | ResolvedPositionAction;
