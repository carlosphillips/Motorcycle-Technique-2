 ...
 */
function identityChipSvg(line: LineResult, width: number): string {
  ...
  return (
    ...
    textEl(
      { x: n3(width - 6), y: 12, "font-family": "sans-serif", "font-size": 8, fill: INK_SECONDARY, "text-anchor": "end" },
      "controls strip · true station"
    ) +
    "</g>"
  );
}
